...
- unified search commands for conjunction, grahan, lunar phase, sankranti, motion, and gochar events (conjunction, sankranti, and motion also accept the lunar nodes as transit bodies: 10007=Rahu, 10008=Ketu)
