...
const ALL_SAMVATSARA_NAMES: [&str; 60] = [
    ...
    "Eeshvara", "Bahudhanya", "Pramaathi", "Vikrama", "Vrisha",
    "Chitrabhanu", "Svabhanu", "Taarana", "Paarthiva", "Vyaya",
    "Sarvajit", "Sarvadhari", "Virodhi", "Vikruti", "Khara",
    "Nandana", "Vijaya", "Jaya", "Manmatha", "Durmukhi",
    "Hevilambi", "Vilambi", "Vikari", "Sharvari", "Plava",
    "Shubhakrut", "Shobhakrut", "Krodhi", "Vishvavasu", "Paraabhava",
    "Plavanga", "Keelaka", "Saumya", "Sadharana", "Virodhikrut",
    "Paridhavi", "Pramaadhi", "Aananda", "Raakshasa", "Naala",
    "Pingala", "Kaalayukti", "Siddharthi", "Raudri", "Durmathi",
